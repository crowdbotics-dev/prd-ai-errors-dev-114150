"""
Django settings for prd_ai_errors_dev_114150 project.
...
ROOT_URLCONF = 'prd_ai_errors_dev_114150.urls'
...
WSGI_APPLICATION = 'prd_ai_errors_dev_114150.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prd_ai_errors_dev_114150 API",
    "DESCRIPTION": "API documentation for prd_ai_errors_dev_114150 App",
    "VERSION": "v1",
}
